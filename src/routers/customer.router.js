...
var CustomerRouter = /** @class */ (function (_super) {
    ...
    function CustomerRouter(mongoDBConnection) {
        var _this = _super.call(this) || this;
        _this.model = new CustomerModel_1.CustomerModel(mongoDBConnection);
        return _this;
    }
    CustomerRouter.prototype.initializeRoutes = function () {
        ...
        this.router.get('/', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var _a, firstName, email, filter, customer, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.query, firstName = _a.firstName, email = _a.email;
                        filter = {};
                        if (firstName) {
                            filter = (0, collectionFilter_1.createCaseInsensitiveFilter)(filter, 'firstName', firstName);
                        }
                        if (email) {
                            filter = (0, collectionFilter_1.createCaseInsensitiveFilter)(filter, 'email', email);
                        }
        ...
        this.router.post('/', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var newCustomer, result, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        newCustomer = req.body;
                        return [4 /*yield*/, this.model.insertMany(newCustomer)];
                    case 1:
                        result = _a.sent();
                        if (result) {
                            res.status(201).send("Successfully created a new customer with result ".concat(result));
                        }
                        else {
